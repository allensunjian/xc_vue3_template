...
import { getChannels, getOrganStores, costumerStatus } from "@/http/modules/option_block"
...
export default {
    ...
    setup(props: any, ctx: SetupContext<EmitsOptions>) {
                ...
                },
                {
                    ...
                    config: {
                        ...
                        onClick: () => {
                            ...
                            options.data.patientStatus = values.patientStatus;
        ...
        onMounted(() => {
            ...
            costumerStatus().then((list: any) => {
                list.push({
                    label: "全部顾客状态",
                    value: -1
                })
                options.depData.costumerStateOptions = list
            })
        })
        return {
