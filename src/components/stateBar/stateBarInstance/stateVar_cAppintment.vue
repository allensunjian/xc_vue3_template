 ...
 * @LastEditTime: 2022-10-06 10:58:09
...
import { getChannels, getOrganStores } from "@/http/modules/option_block"
                ...
                },
                {
                    ...
                    config: {
                        ...
                        onClick: () => {
                            ...
                            options.data.appointType = values.appointType;
