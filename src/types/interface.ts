...
export interface IHttpResponse<T = any> extends IObject {
  code: number;
  msg: string;
  data: T;
}
...
//    * 失效接口，是否需要批量？
//    */
//   invalidIsBatch?: boolean;
//   /**
//    * 失效接口，批量状态下由那个key进行标记操作？比如：pid，uid...
//    */
//   invalidIsBatchKey?: string;
//   /**
//    * 查询采用post请求
//    */
//   postQuery?: boolean;
...
//    * 字典组
//    */
//   getDictLabels: (dictType: string, dictValue: string[]) => string;
//   /**
//    * 获取字典名称
//    */
...
//    * 获取字典样式
//    */
//   getDictStyle: (dictType: string, dictValue: number) => string | number;
//   /**
//    * 获取字典名称
//    */
...
//    *
//    */
//   invalidHandle: (id?: string, pid?: string) => Promise<any>;
// }
